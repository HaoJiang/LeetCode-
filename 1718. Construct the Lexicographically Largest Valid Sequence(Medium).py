...
# if in the first position where a and b differ, sequence a has a number greater than the corresponding number
# in b. For example, [0,1,9,0] is lexicographically larger than [0,1,5,6]
